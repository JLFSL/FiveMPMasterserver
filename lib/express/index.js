...
app.get('/v2/versions', require('./middleware/basic'));
app.put('/v2/versions', require('./middleware/basic'));
app.post('/v2/versions', require('./middleware/basic'));
app.delete('/v2/versions', require('./middleware/basic'));

app.put('/v2/servers', require('./middleware/basic'));
app.post('/v2/servers', require('./middleware/fivemp'));
app.delete('/v2/servers', require('./middleware/fivemp'));

require('./routes/announcements');
require('./routes/categories');
require('./routes/forums');
